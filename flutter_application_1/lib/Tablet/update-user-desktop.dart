...
class UpdateUserDesktop extends StatefulWidget {
  late String userId;
  final String email;
  ...
  @override
  State<UpdateUserDesktop> createState() {
    return _UpdateUserDesktopState();
  }
}

class _UpdateUserDesktopState extends State<UpdateUserDesktop> {
